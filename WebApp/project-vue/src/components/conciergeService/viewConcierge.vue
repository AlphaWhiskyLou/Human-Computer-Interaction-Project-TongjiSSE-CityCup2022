...
<script>
import webTop from '@/components/backStageManagement/webTop.vue';
import NavMenu from '@/components/backStageManagement/NavMenu.vue';
export default {
  path: 'Index',
  components: {
    webTop,NavMenu,
...
.close-nav-logo{width: 100%;height: 100%;background: url('/static/small_logo_menu.jpeg') no-repeat center center;background-size: 60%;}
